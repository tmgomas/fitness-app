    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <div class="p-6 bg-white border-b border-gray-200">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="{{ route('users.create') }}" class="bg-[#f84525] text-white py-2 px-4 rounded-md hover:bg-red-700">
                    Add User
                </a>
            </div>
            ...
            <div class="mb-6">
                <form action="{{ route('users.index') }}" method="GET" class="flex gap-4">
                    ...
                    <div>
                        <select name="role" class="rounded-md border-gray-300 shadow-sm focus:border-[#f84525] focus:ring focus:ring-[#f84525] focus:ring-opacity-50">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $user->is_admin ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800' }}">
