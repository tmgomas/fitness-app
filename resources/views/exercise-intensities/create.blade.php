    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <div class="p-6 bg-white border-b border-gray-200">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-2xl font-semibold">Create Exercise Intensity</h2>
                <a href="{{ route('exercise-intensities.index') }}" class="text-gray-500 hover:text-gray-700">
                    Back to List
                </a>
            </div>

            <form action="{{ route('exercise-intensities.store') }}" method="POST">
                @csrf
                ...
                <div class="bg-gray-50 p-4 rounded-lg mb-6">
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.1" name="calorie_multiplier" id="calorie_multiplier" value="{{ old('calorie_multiplier') }}"
