            ...
            <form action="{{ route('meals.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="bg-gray-50 p-4 rounded-lg mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <!-- Serving Size -->
                        <div>
                            <label for="default_serving_size" class="block text-sm font-medium text-gray-700">Default
                                Serving Size</label>
                ...
                <div class="bg-gray-50 p-4 rounded-lg mb-6">
                    ...
                    <div id="food-items-container">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4 items-center food-item-row">
                            ...
                            <div>
                                <input type="number" step="0.01" name="foods[0][quantity]"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#f84525] focus:ring focus:ring-[#f84525] focus:ring-opacity-50"
                                    placeholder="Quantity">
                            </div>
                            <div>
                                <input type="text" name="foods[0][unit]"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#f84525] focus:ring focus:ring-[#f84525] focus:ring-opacity-50"
                                    placeholder="Unit">
                            </div>
                            <div>
                                <button type="button" class="text-red-600 hover:text-red-900 remove-food-item" disabled>
                                    Remove
                                </button>
                            </div>
                        </div>
