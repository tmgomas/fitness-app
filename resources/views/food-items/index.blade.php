    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <div class="p-6 bg-white border-b border-gray-200">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="{{ route('food-items.create') }}" class="bg-[#f84525] text-white py-2 px-4 rounded-md hover:bg-red-700">
                    Add Food Item
                </a>
            </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach($foodItems as $item)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ $item->serving_size }} {{ $item->serving_unit }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    ...
                                    <form action="{{ route('food-items.destroy', $item) }}" method="POST" class="inline-block">
                                        @csrf
                                        @method('DELETE')
