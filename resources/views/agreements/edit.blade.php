    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <div class="p-6 bg-white border-b border-gray-200">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-2xl font-semibold">Edit Agreement</h2>
                ...
                <div class="bg-gray-50 p-4 rounded-lg mb-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $agreement->title) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="version" id="version" value="{{ old('version', $agreement->version) }}"
                        ...
                        <div>
                            ...
                            <input type="date" name="effective_date" id="effective_date" value="{{ old('effective_date', $agreement->effective_date->format('Y-m-d')) }}"
                        ...
                        <div class="flex items-center mt-6">
                            <input type="checkbox" name="is_active" id="is_active" value="1" 
                                {{ old('is_active', $agreement->is_active) ? 'checked' : '' }}
                    ...
                    <div class="mt-6">
                        ...
                        <textarea name="summary" id="summary" rows="3"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#f84525] focus:ring focus:ring-[#f84525] focus:ring-opacity-50 @error('summary') border-red-500 @enderror">{{ old('summary', $agreement->summary) }}</textarea>
                    ...
                    <div class="mt-6">
                        ...
                        <textarea name="content" id="content" rows="15"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#f84525] focus:ring focus:ring-[#f84525] focus:ring-opacity-50 @error('content') border-red-500 @enderror">{{ old('content', $agreement->content) }}</textarea>
                        @error('content')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
